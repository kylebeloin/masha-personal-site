...
the design and administration of the test.
  ...
  },
  {
    ...
    // Label at bottom of card (Header)
    title: "Lexico-Grammatical and Acoustic Features of Transitional Language in Spoken Discourse",
    // Primary text on card
    "description": (<> Using the BNC-S 2014 corpus of conversations, the study attempts to apply a corpus-driven method of keyword analysis, lexical bundle analysis, and accompanying analysis of suprasegmental speech features to identify the linguistic features that characterize the shifts in the communicative purpose in spoken discourse. The results of the study will help us understand how shifts in communicative purpose happen in conversations and what linguistic features the speakers use to accomplish such shifts.
                    </>),
    // Appears in grey at top of card
  ...
  },
  {
    ...
    // Primary text on card
    description: (<> The project investigates the role of prosodic features of refusals produced by L1 and L2 English users in L1 and L2 English listeners appropriateness perceptions. Refusals produced by L1 English and L2 English speakers from China are rated for appropriateness by listeners from different language backgrounds (L1 English, L2 English speakers from China, Spain, and India). In order to better capture the concept of appropriateness and how it is understood and used by the listeners, the study triangulates perception surveys and 
                    stimulated recalls with a focus group. The study results will demonstrate how appropriateness is operationalized by speakers of World Englishes, and what linguistic features play a role in appropriateness perceptions of speakers from Inner, Outer, and Expanding Circles of English.
                    The study results will inform English teaching practices as well as the development of teaching materials that focus on learners` interactional success in global communication, espsecially in performing speech acts.
                    </>),
    // Appears in grey at top of card
    role: "Co-principal Investigator",
